...
class UserController extends Controller
{
    public function behaviors()
    {
        ...
        $behaviors['authenticator'] = [
            'except' => ['send-invite', 'signup-mob', 'signup-web', 'get-areas', 'verify', 'login-facebook', 'login-google'],
   ...
   public function actionSendInvite()
   {
        ...
        $message = Yii::$app->mailer->compose();
                ...
                $message
                    ...
                    ->setHtmlBody('Для продолжения регистрации перейдите по ссылке https://iskakov.stream.fokin-team.ru/auth/signup-user ');
